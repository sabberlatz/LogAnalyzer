...
Public NotInheritable Class SplashScreen1
    ...
    Private Sub LogAnalyzer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LogAnalyzer.Click
    ...
    Private Sub SplashScreen1_Load(ByVal sender As Object, _
        ...
        If My.Application.Info.Title <> "" Then
            LogAnalyzer.Text = My.Application.Info.Title

        Else
            'Wenn der Anwendungstitel fehlt, Anwendungsnamen ohne Erweiterung verwenden
            LogAnalyzer.Text = System.IO.Path.GetFileNameWithoutExtension(My.Application.Info.AssemblyName)
        End If
